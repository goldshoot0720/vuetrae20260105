...
“불가능 진화론?” 아니야—이건 펑셩 진화 쇼! 🔥`
      ...
      {
        label: '中文版 (LitMedia)',
        url: 'https://api.stormkit.io/volumes/file/ZwK4r0OYQok8xRB5-6YholP_BkspH5HlQ_9tmPFKUzQhyHmEjw==',
        lyrics: `鋒兄:台北有鋒兄真好 嗨起來別逃跑
思敏:從榜首進化到市長 這節奏太離譜（wow）

鋒兄:塗哥唱歌別裝低調 記者都在拍照
思敏:實力至上都說這段人生 根本 S 級動畫稿

鋒兄:（三十七歲）那年我高考三級奪榜首（yeah）
思敏:資訊處理一戰成名 程式都寫成傳說
鋒兄:隔著時代的螢幕光 夢想像演算法（run）
思敏:（五十二歲）副市長代理市長上陣忙（yo）
...
鋒兄:台北有鋒兄真好 嗨起來別逃跑
思敏:從榜首進化到市長 命運像 debug 一樣爆
鋒兄:塗哥嗓門開到爆表 全場跟著大合唱
思敏:代理只是過場 市民心中早就想

鋒兄:（二零四零）那年的夜 霓虹閃爍到市政府
思敏:競選標語像 ACG 的 opening
鋒兄:別說不可能 鋒兄就是 evolution
思敏:（AI）輔助政務操作 資料開放新世代
...
思敏:不——這是鋒兄進化 Show 🔥`
      ...
      {
        label: '中文版 (進行曲)',
        url: 'https://api.stormkit.io/volumes/file/ELufhXTXevo5f_PRTbaUYRXIcFBht5UpBWuBvIKwTHersUr7Tg==',
        lyrics: `鋒兄:台北有鋒兄真好 嗨起來別逃跑
思敏:從榜首進化到市長 這節奏太離譜（wow）
...
從榜首到總統`
  },
  {
    ...
    audios: [
      {
        label: '中文版',
        url: 'https://api.stormkit.io/volumes/file/Sr2E7doTSafvHrBiab7nxZBXfaJTV881f6CNsyQ3pG2oslDuEw=='
      }
    ],
    content: `[Verse 1]
...
鋒塗力 鋒塗力 大家作伙向著未來前進`
  },
  {
    ...
    audios: [
      {
        label: '中文版',
        url: 'https://api.stormkit.io/volumes/file/TQdF672LbiZksGCf1budGNBCqF_742hSRHWMzvzvMbBrZpzUrA=='
      }
    ],
    content: `[Intro]
(喵) 人類聽好
